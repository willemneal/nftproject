    ...
    <div className="hero__container">
      ...
      <div className="hero__information">
        ...
        <p className="hero__text--point">
          <span>
            A high-class collection of 2000 algorithmically generated NFTs on
            NEAR Protocol.
            <br />
            The Academy resides in Los Tigres, a city full of opportunities, its
            citizens are eligible for the following:
          </span>
        </p>
        <p className="hero__text--point">1) 100 traits for PFP</p>
        <p className="hero__text--point">
          2) Investment in promising student researchers
        </p>
        <p className="hero__text--point">3) Membership in the EnDAOment Fund</p>
        <p className="hero__text--point">4) Lotteries</p>
        <p className="hero__text--point">
          5) Special conditions on future projects
        </p>

        <p className="hero__text--select">
          Select the amount of NEAR Tigers you\'d like to mint and click the
          «Mint».
        </p>
